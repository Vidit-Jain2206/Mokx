...
const Vedas = () => {
  return (
    <div className="h-auto max-w-[1440px] bg-[#69235B]">
      {/* Cover Pic */}
      <div className="w-full h-[40%] lg:h-[35rem] relative">
        ...
        <div className="z-1 absolute bottom-[-0.5rem] lg:bottom-[-1rem] left-0  w-full">
          <p className=" font-[kumbh] w-[11rem] min-[420px]:w-[14rem] sm:w-[20rem] md:w-[25rem] lg:w-[30rem] mx-auto rounded-xl text-center bg-[#CBCBFF] py-[0.5rem] min-[420px]:py-[0.6rem] sm:py-[0.75rem] md:py-[1rem] lg:py-[1.25rem] text-[1rem] sm:text-[1.25rem] lg:text-[1.5rem] leading-[0.875rem] tracking-[0.00625rem] ">
            Arya, AI Acharya
          </p>
        </div>
      </div>
      ...
      <div className="w-[90%] mx-auto flex flex-col justify-center mt-[1.5rem] lg:mt-[2rem]">
        <h1 className=" font-[kumbh] text-[2rem] font-bold not-italic text-white">
          Discover the timeless wisdom of{" "}
          <span className="text-[#FFC746]">the Vedas.</span>
        </h1>
        <p className=" mt-[0.5rem] text-white text-[1rem] font-light not-italic leading-[1.625rem]">
          Sign up and{" "}
        ...
        <div className="my-4 flex items-center before:border-t-[1px] before:border-[#CDD1D0] before:z-0 before:w-[50%] after:border-t-[1px] after:border-[#CDD1D0] after:w-[50%]">
          <p className="font-[kumbh] text-center mx-4 tracking-[0.00625rem] leading-5 font-thin text-[1.125rem] text-[#fff]">
            OR
          </p>
        </div>
